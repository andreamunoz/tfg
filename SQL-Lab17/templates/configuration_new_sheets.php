...
<div class="container-tabla pt-4 pb-5">
    <label><a class="enlace" href="configuration.php" >Configuración </a> > <a class="enlace" href="configuration_sheets.php" > Hoja de Ejercicios</a> > <a class="enlace" href="configuration_new_sheets.php" > Nueva Hoja</a></label>
    <h2><strong>Nueva Hoja</strong></h2>
    <div class="row mb-5">
        <div class="col-md-12">
                        ...
                        <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade mt-3 pl-4" id="nav-exercises" role="tabpanel" aria-labelledby="nav-exercises-tab">
                                ...
                                <div class="form-group text-right">
                                    <button class="btn btn-primary pl-5 pr-5 mt-5 mb-5" name="new_sheet" type="submit">Crear Hoja</button>
                                </div>
                            </div>
                        </div>
                        <?php
