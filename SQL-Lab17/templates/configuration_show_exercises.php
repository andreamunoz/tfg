...
<div class="container-tabla pt-4 pb-5">
    ...
    <div id="accordion" class="col-md-8 p-0 float-right">
        <div class="card">  
    ...
    <div class="col-md-8 p-0 float-right" id="accordion ">
        <div class="card">  
            <div class="table-responsive">                
                <table id="employee" class="table table-striped table-bordered"> 
                    <thead>
                    ...
                    <tbody>
                    <td style="padding-left: 100px"> <?php echo $ejercicioId['enunciado']; ?> </td>
                    </tbody>
                </table>
            </div>
        </div>
        ...
        <div class="card">  
            <div class="table-responsive">                
                <table id="employee" class="table table-striped table-bordered"> 
                    ...
                    <tbody>
                    <td style="padding-left: 100px"> <?php echo '???' ?> </td>
                    </tbody>
                </table>
            </div>
        </div>
