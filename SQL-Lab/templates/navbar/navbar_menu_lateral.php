    ...
    <div class="menu-list">	
        <ul id="menu-content" class="menu-content collapse out">   
            ...
            <ul class="sub-menu collapse" id="ejercicios">
              <li class="" id="licrej"><a id="crear_ejercicio" href="#crear"><?php echo trad('Crear Ejercicio',$lang) ?></a></li>
              <li class="" id="liliej"><a id="lista_ejercicio" href="#lista"><?php echo trad('Gestión de Ejercicios',$lang) ?></a></li>
            </ul>
            ...
            <ul class="sub-menu collapse" id="hojas">
                <li class="" id="licrho"><a id="crear_hoja" href="#"><?php echo trad('Crear Hoja',$lang) ?></a></li>
                <li class="" id="liliho"><a id="lista_hoja" href="#"><?php echo trad('Gestión de Hojas',$lang) ?></a></li>    
            </ul>         
            ...
            <ul class="sub-menu collapse" id="configurar">
              <li class="" id="liperf"><a id="perfil" href="#"><?php echo trad('Perfil',$lang) ?></a></li>
            </ul>  
