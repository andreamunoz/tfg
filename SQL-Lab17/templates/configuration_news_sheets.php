...
<div class="container-tabla pt-4 pb-5">
    ...
    $id_hoja = $_GET['hoja'];
    ?>
    <label><a class="enlace" href="configuration.php" ><?php echo trad('Modo Profesor',$lang) ?> </a> > <a class="enlace" href="configuration_sheets.php" > <?php echo trad('Hoja de Ejercicios',$lang) ?></a> > <a class="enlace" href="configuration_news_sheets.php?hoja=<?php echo $id_hoja?>" > <?php echo trad('Nueva Hoja',$lang) ?></a></label>
            ...
            <div class="row">
                <div class="col-md-12 ">
                        <div class="form-group text-right">
                            <button class="btn btn-primary pl-5 pr-5 mt-1 createSheet" name="<?php echo $id_hoja ?>" ><?php echo trad('Guardar Hoja', $lang) ?></button>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 p-0">                                    
                                <input type="text" maxlength="50" id="new_name_sheet" name="new_name_sheet" value="" class="form-control form-control-sm" required/>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div id="accordion ">
                            <div class="card">  
                                <div class="table-responsive">  
                                    <table id="employee_table_hoja" class="table table-striped-conf table-bordered table-sortable" value="<?php echo $id_hoja?>">  
                                        <thead>
                                            <tr> 
