...
<div class="container-tabla pt-4 pb-5">
    ...
    ?>
    <label><a class="enlace" href="index.php" >Inicio </a> > <a class="enlace" href="exercises.php" > Ejercicios</a> > <a class="enlace" href="perform_exercise.php?exercise=<?php echo $id_ejer ?>" > Realizar Ejercicio</a></label>
    <h2><strong>Realizar Ejercicio | <?php echo $des ?></strong></h2>
    <div class="row mb-5">
        <?php
        $tabla = new Tablas();
        ...
        ?>
        <div class="col-md-10">
            <p>Resuelve el ejercicio según el enunciado propuesto por el profesor.</p>
        </div>
        ...
        <div class="card">  
            <div class="table-responsive">                
                <table id="employee" class="table table-striped table-bordered"> 
                    <thead>
                        <tr>
                            <th style="width:20%; text-align: center">Solución</th>                         
                        </tr>
                    </thead>
                    <tbody>
                ...
                <button type="submit" id="alert-sol" class="btn btn-primary mt-5 mb-5 pl-5 pr-5 float-right">Solucionar</button>
            </div>
        </div>
    </div>
        ...
        <div class="card">  
            <div class="table-responsive">                
                <table id="employee" class="table table-striped table-bordered"> 
                    <thead>
                        <tr>
                            <th style="width:20%; text-align: center">Enunciado</th>                         
                        </tr>
                    </thead>
                    <tbody>
